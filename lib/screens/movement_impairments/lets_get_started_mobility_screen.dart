...
class LetsGetStartedMobilityScreen extends StatelessWidget {
  LetsGetStartedMobilityScreen({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Center(
                ...
                children: [
                  ...
                  Text(
                    'Explore both inside and outside a typical\nhome and discover a range of mobility\nhazards and how to fix them.',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: themeController.phone
                          ? Get.width * 0.035
        ...
        children: [
              ...
              child: Container(
                ...
                child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Move around the home using the arrows. Tap on any object you think might cause an obstruction to learn more about the problem and how it can be fixed.',
                          style: TextStyle(
                        ...
                        const SizedBox(height: 20),
                        Text(
                          'Over 1 billion people are estimated to experience mobility issues or a physical disability worldwide. In the UK there are over 1.6 million people who use a wheelchair and many more will have other mobility issues. ',
                          style: TextStyle(
                            color: Colors.grey.shade800,
                            fontSize: themeController.phone
                                ? Get.width * 0.035
          ...
          Positioned(
            ...
            child: InkWell(
              ...
              splashFactory: NoSplash.splashFactory,
              onTap: () {
                Get.toNamed('/mobilityOptionsScreen');
              },
              child: ClipRRect(
                borderRadius: BorderRadius.circular(50),
                child: Container(
