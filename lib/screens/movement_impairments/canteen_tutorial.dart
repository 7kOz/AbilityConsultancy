...
class CanteenTutorial extends StatefulWidget {
  const CanteenTutorial({super.key});

  @override
  State<CanteenTutorial> createState() => _CanteenTutorialState();
}

class _CanteenTutorialState extends State<CanteenTutorial> {
  CachedVideoPlayerController controller = CachedVideoPlayerController.network(
      'https://firebasestorage.googleapis.com/v0/b/ability-consultant.appspot.com/o/Tutorials%2FKitchen-2.mp4?alt=media&token=61f348ee-cf1d-408d-9bc8-4731ce74fe30');
        ...
        child: controller.value.isInitialized
            ? Column(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      movementController.toggleCanteen();
                    },
                    child: ClipRRect(
