...
class LossOfHalfVisionInOneEyeScreen extends StatefulWidget {
  List<CameraDescription> cameras;
  LossOfHalfVisionInOneEyeScreen({Key? key, required this.cameras})
      : super(key: key);

  @override
  State<LossOfHalfVisionInOneEyeScreen> createState() =>
      _LossOfHalfVisionInOneEyeScreenState();
}

class _LossOfHalfVisionInOneEyeScreenState
    extends State<LossOfHalfVisionInOneEyeScreen> {
