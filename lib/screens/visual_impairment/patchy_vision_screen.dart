...
class PatchyVisionScreen extends StatefulWidget {
  List<CameraDescription> cameras;
  PatchyVisionScreen({Key? key, required this.cameras}) : super(key: key);

  @override
  State<PatchyVisionScreen> createState() => _PatchyVisionScreenState();
}

class _PatchyVisionScreenState extends State<PatchyVisionScreen> {
      ...
      body: Stack(
        children: [
          ...
          Opacity(
            opacity: 0.8,
            child: Image.asset(
              'assets/images/patchyVisionBg.png',
              height: Get.height,
              width: Get.width,
              fit: BoxFit.fill,
            ),
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            'Patch vision is common in many sight conditions, and is particularly found in Diabetic Retinopathy which is caused by diabetes.',
                                            style: TextStyle(
