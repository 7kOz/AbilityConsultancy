...
class LightPerceptionInBothEyesScreen extends StatefulWidget {
  List<CameraDescription> cameras;
  LightPerceptionInBothEyesScreen({Key? key, required this.cameras})
      : super(key: key);

  @override
  State<LightPerceptionInBothEyesScreen> createState() =>
      _LightPerceptionInBothEyesScreenState();
}

class _LightPerceptionInBothEyesScreenState
    extends State<LightPerceptionInBothEyesScreen> {
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            'Severe loss of vision giving light perception only. People can distinguish between light and dark but have no useful vision.',
                                            style: TextStyle(
