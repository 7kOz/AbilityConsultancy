...
class ReducedClarityOfVisionScreen extends StatefulWidget {
  List<CameraDescription> cameras;
  ReducedClarityOfVisionScreen({Key? key, required this.cameras})
      : super(key: key);

  @override
  State<ReducedClarityOfVisionScreen> createState() =>
      _ReducedClarityOfVisionScreenState();
}

class _ReducedClarityOfVisionScreenState
    extends State<ReducedClarityOfVisionScreen> {
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            'This is just below the legal driving limit for sight in the UK. Reduced clarity is often seen as an early stage of many eye conditions.',
                                            style: TextStyle(
